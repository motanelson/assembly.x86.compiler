...
public class asmParserApp {
    ...
    public static void main(String[] args) {
        ...
        // ==========================
        if (args.length == 0) {
            System.out.println("Uso: java asmParserApp <ficheiro.asm>");
            return;
        }
        ...
        try {
            ...
            asmLexer lexer = new asmLexer(charStream);
            ...
            for (Token token : tokens.getTokens()) {
                String name = asmLexer.VOCABULARY.getSymbolicName(token.getType());
